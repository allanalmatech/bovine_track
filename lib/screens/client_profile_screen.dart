    ...
    return Scaffold(
      ...
      body: StreamBuilder<Map<String, Map<String, dynamic>>>(
        ...
        builder: (context, statusSnap) {
          ...
          final lng = (status?['lng'] as num?)?.toDouble();
          final speed = (status?['speed'] as num?)?.toDouble();
          final ts = (status?['lastSeen'] as num?)?.toInt();
              ...
              return StreamBuilder<List<ManagedBoundary>>(
                ...
                builder: (context, boundariesSnap) {
                  ...
                  final assignedBoundaries = allBoundaries
                      .where(
                        (b) => b.assignedClients.contains(widget.client.uid),
                      )
                      .toList();
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (allBoundaries.isEmpty)
                                ...
                                ...allBoundaries.map((b) {
                                  final assigned = b.assignedClients.contains(
                                    widget.client.uid,
                                  );
                                  ...
                                  return CheckboxListTile(
                                    ...
                                    onChanged: busy
                                        ...
                                        : (value) async {
                                            ...
                                            setState(() => _saving.add(b.id));
                                            try {
                                              await _rbac.setBoundaryAssignment(
